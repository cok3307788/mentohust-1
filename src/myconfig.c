...
#endif
static const char *CFG_FILE = "data/data/com.termux/files/usr/etc/mentohust.conf";	/* 配置文件 */
static const char *LOG_FILE = "data/data/com.termux/files/usr/tmp/mentohust.log";	/* 日志文件 */
static const char *LOCK_FILE = "data/data/com.termux/files/usr/var/run/mentohust.pid";	/* 锁文件 */
